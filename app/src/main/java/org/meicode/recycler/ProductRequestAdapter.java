    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.messageCustomerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // For example, show a dialog or navigate to a chat screen
                // For simplicity, you can show a toast or log the message
                // Toast.makeText(v.getContext(), "Message to: " + productRequest.getUserDetails(), Toast.LENGTH_SHORT).show();
            }
        });
    }
